...
export default function AddModal({ open, setOpen }) {
    ...
    function addImage(evt){
        ...
        auth.Axios.post("/images/gallery",data).then(res => {console.log(res)}).catch(err => console.error(err))
    }
        ...
        <Transition.Root show={open} as={Fragment}>
            ...
            >
                <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    >
                        <form onSubmit={addImage}    className="relative inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                                                ...
                                                <div className="space-y-1 text-center">
                                                    ...
                                                    <div className="flex text-sm text-gray-600">
                                                        <span>Upload a file</span>
                                                            ...
                                                            <input onChange={changeImage} required={true} id="file-upload" accept="image/png, image/gif, image/jpeg, image/webp" name="images" type="file" className="sr-only" />
